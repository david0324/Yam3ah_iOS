...
+ (MBProgressHUD *)showHUDAddedTo:(UIView *)view animated:(BOOL)animated
{
    ...
    hud.transform=CGAffineTransformMakeRotation( M_PI + M_PI/2 );
	[view.window addSubview:hud];
	[hud show:animated];
	return MB_AUTORELEASE(hud);
}
*/
+ (MBProgressHUD *)showHUDAddedTo:(UIWindow *)view animated:(BOOL)animated
{
...
+ (BOOL)hideHUDForView:(UIView *)view animated:(BOOL)animated {
	MBProgressHUD *hud = [MBProgressHUD HUDForView:view.window];
	if (hud != nil) {
...
+ (NSUInteger)hideAllHUDsForView:(UIView *)view animated:(BOOL)animated {
    ...
    NSArray *huds = [self allHUDsForView:view.window];
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
        ...
        //self.backgroundColor = [UIColor colorWithRed:1.02 green:0.53 blue:1.61 alpha:0.5];
...
- (void)drawRect:(CGRect)rect {
	...
	if (_annular) {
       ...
       // [[UIColor colorWithRed:1.02 green:0.53 blue:1.62 alpha:0.1] set];
