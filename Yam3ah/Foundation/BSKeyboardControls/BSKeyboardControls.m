...
- (id)init
{
    if (self = [super init])
    {
     ...
     //   self.previousNextTintColor = [UIColor colorWithRed:211.0/255.0 green:158.0/255.0 blue:73.0/255.0 alpha:1.0];
        self.previousNextTintColor = [UIColor whiteColor];
        // Default labels
        ...
        self.toolbar.barTintColor = [UIColor colorWithRed:68.0/255.0 green:179.0/255.0 blue:166.0/255.0 alpha:1.0];
        //self.toolbar.backgroundColor=[UIColor greenColor];
        //self.toolbar.backgroundColor = [UIColor clearColor];
        self.toolbar.backgroundColor = [UIColor colorWithRed:68.0/255.0 green:179.0/255.0 blue:166.0/255.0 alpha:1.0];
        ...
        self.segmentedPreviousNext.tintColor = [UIColor whiteColor];
        
//        self.segmentedPreviousNext.tintColor = [UIColor colorWithRed:211.0/255.0 green:158.0/255.0 blue:73.0/255.0 alpha:1.0];
        ...
        barSegment.tintColor = [UIColor whiteColor];
        // Create spacing
...
- (void)setDoneTintColor:(UIColor *)doneTintColor
{
    ...
    self.buttonDone.tintColor=[UIColor whiteColor];
}
