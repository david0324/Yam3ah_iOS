...
/*- (BOOL) validatePassword: (NSString *) candidate {
    NSMutableCharacterSet *characterSet = [NSMutableCharacterSet characterSetWithCharactersInString:@"\'^£$%&*()}{@#~?><>,|=_+¬-1234567890"];
    
    BOOL isAllAlpha = [self validateAlpha:candidate];
    if (isAllAlpha == NO)
    {
        //[characterSet addCharactersInString:@"\'^£$%&*()}{@#~?><>,|=_+¬-1234567890"];
        return [self validateStringInCharacterSet:candidate characterSet:characterSet];
    }
    return nil;
}*/
